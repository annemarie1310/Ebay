...
public class automonile_Ultimate {
    public static void main(String[] args) throws InterruptedException {
        ...
        String price=driver.findElement(By.xpath("//table[@id=\"priceTable\"]//tbody/tr[1]/td[5]")).getText();
        String Onlineclaim=driver.findElement(By.xpath("//table[@id=\"priceTable\"]//tbody/tr[2]/td[5]")).getText();
        String ClaimsDisc=driver.findElement(By.xpath("//table[@id=\"priceTable\"]//tbody/tr[3]/td[5]")).getText();
        String WorldWideCover=driver.findElement(By.xpath("//table[@id=\"priceTable\"]//tbody/tr[4]/td[5]")).getText();

        if (price.equalsIgnoreCase("1,572.00")&&Onlineclaim.equalsIgnoreCase("Submit")&&ClaimsDisc.equalsIgnoreCase("10")&&WorldWideCover.equalsIgnoreCase("Unlimited")){
