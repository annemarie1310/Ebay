...
public class Truck {
    public static void main(String[] args) throws InterruptedException {
        ...
        carmake.selectByVisibleText("Skoda");
        // Enter Engine Cc .
        ...
        //Enter payload
        driver.findElement(By.xpath("//input[@id=\"payload\"]")).sendKeys("1000");
        //Select Total Weight
        driver.findElement(By.xpath("//input[@id=\"totalweight\"]")).sendKeys("4000");
        // input Price .
        driver.findElement(By.xpath("//input[@id=\"listprice\"]")).sendKeys("100000");
        // License Plate
        driver.findElement(By.xpath("//input[@id=\"licenseplatenumber\"]")).sendKeys("6TRJ254");
        //Select Mielage
        ...
        // ---------------5th Page below -------------------------------
        // Enter Email .
        driver.findElement(By.xpath("//input[@id=\"email\"]")).sendKeys("akk@gl.commm");
        //enter Phone Number
        ...
        // enter Comments
        driver.findElement(By.xpath("//textarea[@id=\"Comments\"]")).sendKeys("Hello Truck !!");
